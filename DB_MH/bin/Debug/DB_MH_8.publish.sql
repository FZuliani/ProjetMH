...
GO
PRINT N'Dropping unnamed constraint on [dbo].[Fréquence]...';


GO
ALTER TABLE [dbo].[Fréquence] DROP CONSTRAINT [DF__Fréquence__frequ__145C0A3F];
...
ALTER TABLE [dbo].[Fréquence]
    ADD DEFAULT 440.00 FOR [frequence];
